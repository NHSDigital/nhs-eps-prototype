 ...
 router.get("/epsv10/prescription-template", function (req, res) {
  ...
  const prescription = matchedPrescription[Object.keys(matchedPrescription)[0]];
    ...
    console.log("Prescription Details:", {
      ...
      prescriptionItems: [
        { nameItem1: prescription.prescriptionItem1, quantityItem1: prescription.prescriptionItem1quantity, pendingCancellationItem1: prescription.prescriptionItem1pendingCancelation, cancellationReasonItem1:prescription.prescriptionItem1cancellationreason, quantityItem1: prescription.prescriptionItem1quantity, instructionItem1: prescription.prescriptionItem1instructions, itemstatusItem1: prescription.prescriptionItem1Status, NHSAppItem1: prescription.prescriptionItem1PrescNHSApp},
        { nameItem2: prescription.prescriptionItem2, quantityItem2: prescription.prescriptionItem2quantity, pendingCancellationItem2: prescription.prescriptionItem2pendingCancelation, cancellationReasonItem2:prescription.prescriptionItem2cancellationreason, quantityItem2: prescription.prescriptionItem2quantity, instructionItem2: prescription.prescriptionItem2instructions, itemstatusItem2: prescription.prescriptionItem2Status, NHSAppItem2: prescription.prescriptionItem2PrescNHSApp},
      ],
